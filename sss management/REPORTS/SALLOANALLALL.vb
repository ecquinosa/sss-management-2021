...
Public Class SALLOANALLALL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.SALLOANALLALL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSALLOANALLALL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SALLOANALLALL = New SALLOANALLALL()
        rpt.Site = Me.Site
        Return rpt
    End Function
