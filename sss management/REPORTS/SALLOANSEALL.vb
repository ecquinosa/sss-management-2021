...
Public Class SALLOANSEALL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.SALLOANSEALL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSALLOANSEALL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SALLOANSEALL = New SALLOANSEALL()
        rpt.Site = Me.Site
        Return rpt
    End Function
