...
Public Class SALLOANVOLALL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.SALLOANVOLALL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSALLOANVOLALL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SALLOANVOLALL = New SALLOANVOLALL()
        rpt.Site = Me.Site
        Return rpt
    End Function
