...
Public Class SUCFAILEDALL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.SUCFAILEDALL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSUCFAILEDALL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SUCFAILEDALL = New SUCFAILEDALL()
        rpt.Site = Me.Site
        Return rpt
    End Function
