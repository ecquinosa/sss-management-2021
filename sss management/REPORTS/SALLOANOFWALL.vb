...
Public Class SALLOANOFWALL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.SALLOANOFWALL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSALLOANOFWALL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SALLOANOFWALL = New SALLOANOFWALL()
        rpt.Site = Me.Site
        Return rpt
    End Function
